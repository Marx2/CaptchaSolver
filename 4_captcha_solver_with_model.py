...
from helpers import resize_to_fit, get_background, preprocess_image
...
captcha_image_files = list(paths.list_images("test"))
...
for image_file in captcha_image_files:
    ...
    image = preprocess_image(image_file,background)
